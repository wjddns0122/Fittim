...
export function ProductCard({ brand, name, price, tags }: ProductCardProps) {
  const formattedPrice = price.toLocaleString('ko-KR');

  return (
    <div className="flex gap-4 bg-white rounded-2xl overflow-hidden border border-[#F0F0F0] p-3">
      {/* Product Image */}
      ...
      <div className="flex-1 flex flex-col justify-between py-1">
        ...
        <div className="space-y-2.5">
          ...
          <button className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-full bg-[#1A1A1A] text-white text-[12px] hover:bg-[#2A2A2A] transition-colors self-start" style={{ fontWeight: 400 }}>
